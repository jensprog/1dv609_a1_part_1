...
public class MyBuggySwedishSocialSecurityNumberNoValidMonthCheck {

    private SSNHelper helper;
    private String ssn;
    
    public MyBuggySwedishSocialSecurityNumberNoValidMonthCheck(String stringInput, SSNHelper helper) throws Exception {
        this.helper = helper;
