...
public class MyBuggySwedishSocialSecurityNumberNoFormatCheck {

    private SSNHelper helper;
    private String ssn;
    
    public MyBuggySwedishSocialSecurityNumberNoFormatCheck(String stringInput, SSNHelper helper) throws Exception {
        this.helper = helper;
