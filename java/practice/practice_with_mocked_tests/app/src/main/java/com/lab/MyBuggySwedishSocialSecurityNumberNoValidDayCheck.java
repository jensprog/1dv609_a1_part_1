...
public class MyBuggySwedishSocialSecurityNumberNoValidDayCheck {
  
    private SSNHelper helper;
    private String ssn;
    
    public MyBuggySwedishSocialSecurityNumberNoValidDayCheck(String stringInput, SSNHelper helper) throws Exception {
        this.helper = helper;
